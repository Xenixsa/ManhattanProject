...
public class SettingsPanel extends JPanel {
    ...
    private JCheckBox wallCollisionsCheckBox;
    ...
    public SettingsPanel(JFrame jFrame, JPanel mainContainer, CardLayout cardLayout, SettingsManager settingsManager) {
        ...
        boolean wallCollisionsDefault = settingsManager.getStringSetting("wallCollisions", "true").equals("true");
        wallCollisionsCheckBox = new JCheckBox("Kolizje ze ścianami", wallCollisionsDefault);
        wallCollisionsCheckBox.setBackground(Color.BLACK);
        wallCollisionsCheckBox.setForeground(Color.WHITE);
        wallCollisionsCheckBox.setAlignmentX(Component.CENTER_ALIGNMENT);
        wallCollisionsCheckBox.addActionListener(e ->
                settingsManager.set("wallCollisions", String.valueOf(wallCollisionsCheckBox.isSelected()))
        );
